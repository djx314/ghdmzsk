...
trait ConfirmCol {
  ...
  add(CusPlan(key = Tags.Tag103, countSetKey = 698, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i1 * i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag113, countSetKey = 713, c = (i1: Int, i2: Int) => if (i1 == 1) 0 else i1))
  add(CusPlan(key = Tags.Tag114, countSetKey = 714, c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else 2))
  add(CusPlan(key = Tags.Tag115, countSetKey = 715, c = (i1: Int, i2: Int) => if (i1 == 0 || i2 == 0) 0 else if (i1 > i2) i2 else i1 - 1))
  add(CusPlan(key = Tags.Tag116, countSetKey = 719, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 <= i2) i1 - 1 else Option.empty))
  add(
    CusPlan(
      key = Tags.Tag117,
      countSetKey = 720,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) Option.empty else if (i1 % i2 == 0) i1 + i1 / i2 - 2 else i1 + i1 / i2 - 1
    )
  )
  add(CusPlan(key = Tags.Tag118, countSetKey = 722, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i1 - 1))
  add(CusPlan(key = Tags.Tag119, countSetKey = 725, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 > i2) i1 else i1 - 1))
  add(CusPlan(key = Tags.Tag120, countSetKey = 726, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 > i2) i2 + 1 else i1 - 1))
  ...
  add(CusPlan(key = Tags.Tag124, countSetKey = 730, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i2 * 2 + 1))
  ...
  add(CusPlan(key = Tags.Tag131, countSetKey = 737, c = (i1: Int, i2: Int) => if (i2 + 1 - i1 > 0) Option.empty else i2 * 2 + 2))
  ...
  add(CusPlan(key = Tags.Tag146, countSetKey = 752, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 * 2 + i2 / i1))
  add(CusPlan(key = Tags.Tag147, countSetKey = 753, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 * 2 + i2 / i1 + 2))
  add(CusPlan(key = Tags.Tag148, countSetKey = 754, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 * 2 + i2 / i1 + 1))
  add(CusPlan(key = Tags.Tag149, countSetKey = 755, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else if (i1 == 1) 2 else 1))
  add(CusPlan(key = Tags.Tag150, countSetKey = 756, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 + i2 / i1))
  add(CusPlan(key = Tags.Tag151, countSetKey = 757, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 / i1 + i2 + 2))
  add(CusPlan(key = Tags.Tag152, countSetKey = 758, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else i2 / i1 + i2 + 1))
  add(CusPlan(key = Tags.Tag153, countSetKey = 759, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 3 else 2))
  add(CusPlan(key = Tags.Tag154, countSetKey = 760, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 5 else 4))
  add(CusPlan(key = Tags.Tag155, countSetKey = 761, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 4 else 3))
  add(CusPlan(key = Tags.Tag156, countSetKey = 765, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 2 else 1))
  add(CusPlan(key = Tags.Tag157, countSetKey = 769, c = (i1: Int, i2: Int) => if (i1 == 0) 2 else if (i1 == 1) 3 else 4))
  add(CusPlan(key = Tags.Tag158, countSetKey = 770, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i1 == 1) 2 else 3))
  add(CusPlan(key = Tags.Tag159, countSetKey = 774, c = (i1: Int, i2: Int) => if (i1 - i2 <= 1) i1 + i2 + 1 else i2 * 2 + 2))
  ...
  add(CusPlan(key = Tags.Tag168, countSetKey = 786, c = (i1: Int, i2: Int) => i2 * 2 - (i2 + 1) / (i1 + 1) + 2))
  add(CusPlan(key = Tags.Tag169, countSetKey = 787, c = (i1: Int, i2: Int) => i2 * 2 - (i2 + 1) / (i1 + 1) + 1))
  add(
    CusPlan(
      key = Tags.Tag170,
      countSetKey = 789,
  ...
  add(CusPlan(key = Tags.Tag175, countSetKey = 801, c = (i1: Int, i2: Int) => if (i1 > i2) i2 * 2 else i1 + i2 + 1))
  add(
  ...
  add(CusPlan(key = Tags.Tag178, countSetKey = 804, c = (i1: Int, i2: Int) => if (i1 > i2) i1 + i2 else i1 + i2 + 1))
  add(CusPlan(key = Tags.Tag179, countSetKey = 805, c = (i1: Int, i2: Int) => if (i2 - i1 < 1) i2 * 2 + 1 else i1 + 1 + i2))
  add(CusPlan(key = Tags.Tag180, countSetKey = 806, c = (i1: Int, i2: Int) => if (i1 == 0) 2 else i1 + 1))
  ...
  add(CusPlan(key = Tags.Tag200, countSetKey = 826, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i1 == 1) 3 else 2))
  add(CusPlan(key = Tags.Tag201, countSetKey = 827, c = (i1: Int, i2: Int) => if (i1 < 2) i1 * 2 + 1 else Option.empty))
  add(CusPlan(key = Tags.Tag202, countSetKey = 828, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else i1 * 3))
  add(CusPlan(key = Tags.Tag203, countSetKey = 829, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else i1 * i2 + i1 * 2 - i2 + 1))
  ...
  add(CusPlan(key = Tags.Tag210, countSetKey = 836, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 * 2 + 1 else i2 * 2))
  add(CusPlan(key = Tags.Tag211, countSetKey = 837, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i2 == 0) 0 else i1 * 2 + 1))
  ...
  add(
    CusPlan(
      ...
      countSetKey = 839,
      c = (i1: Int, i2: Int) =>
        if (i1 == 0) 1 else if (i2 == 0) Option.empty else if (i1 % i2 == 0) i1 * 2 + i1 / i2 else i1 * 2 + i1 / i2 + 1
    )
  )
  add(CusPlan(key = Tags.Tag214, countSetKey = 841, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 * 2 + 1 else i1 + i2 + 1))
  add(
    CusPlan(
      key = Tags.Tag215,
      countSetKey = 842,
  ...
  add(CusPlan(key = Tags.Tag217, countSetKey = 845, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 * 2 + 1 else i1 + i2))
  ...
  add(
    CusPlan(
      ...
      countSetKey = 850,
      c = (i1: Int, i2: Int) =>
        if (i1 == 0) 1 else if (i2 == 0) Option.empty else if (i1 % i2 == 0) i1 * 2 + i1 / i2 + 1 else i1 * 2 + i1 / i2 + 2
    )
  )
  add(
    CusPlan(
  ...
  add(CusPlan(key = Tags.Tag226, countSetKey = 854, c = (i1: Int, i2: Int) => i1 * i2 + i1 * 2 + 1))
  ...
  add(CusPlan(key = Tags.Tag235, countSetKey = 865, c = (i1: Int, i2: Int) => i1 * 2 - (i1 + 1) / 2 + 1))
  add(
    CusPlan(
      key = Tags.Tag236,
      countSetKey = 866,
  ...
  add(CusPlan(key = Tags.Tag248, countSetKey = 880, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i1 == 1) 2 else i1 + 2))
  ...
  add(CusPlan(key = Tags.Tag251, countSetKey = 883, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 + i2 else i1 + i2 + 1))
  add(CusPlan(key = Tags.Tag252, countSetKey = 884, c = (i1: Int, i2: Int) => if (i1 > i2) i2 * 2 + 2 else i1 + i2))
  ...
  add(CusPlan(key = Tags.Tag256, countSetKey = 888, c = (i1: Int, i2: Int) => if (i1 <= 1) 1 else i1 + 1))
  ...
  add(CusPlan(key = Tags.Tag259, countSetKey = 891, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 else i1 + 1))
  add(CusPlan(key = Tags.Tag260, countSetKey = 892, c = (i1: Int, i2: Int) => if (i1 > i2) i2 + 2 else i2))
  add(CusPlan(key = Tags.Tag261, countSetKey = 893, c = (i1: Int, i2: Int) => if (i1 >= i2) i1 else i2))
  add(CusPlan(key = Tags.Tag262, countSetKey = 894, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 else i2 + 1))
  ...
  add(CusPlan(key = Tags.Tag265, countSetKey = 897, c = (i1: Int, i2: Int) => if (i1 == 0) i2 else i1 + 1))
  ...
  add(
    CusPlan(
      ...
      countSetKey = 919,
      c = (i1: Int, i2: Int) =>
        if (i1 == 0) 0 else if (i2 == 0) Option.empty else if (i1 % i2 == 0) i1 * 2 + i1 / i2 else i1 * 2 + i1 / i2 + 1
    )
  )
  add(
    CusPlan(
  ...
  add(CusPlan(key = Tags.Tag298, countSetKey = 936, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 else i1 + 1))
  ...
  add(CusPlan(key = Tags.Tag303, countSetKey = 941, c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else if (i1 == 1) 6 else 5))
  ...
  add(
    CusPlan(
      ...
      countSetKey = 943,
      c = (i1: Int, i2: Int) =>
        if (i1 == 0) Option.empty else if ((i2 + 1) % i1 == 0) (i2 + 1) * 2 + (i2 + 1) / i1 else (i2 + 1) * 2 + (i2 + 1) / i1 + 1
    )
  )
  ...
  add(CusPlan(key = Tags.Tag318, countSetKey = 956, c = (i1: Int, i2: Int) => i1 * 2 + 2))
  add(CusPlan(key = Tags.Tag319, countSetKey = 957, c = (i1: Int, i2: Int) => i1 * 2 + 4))
  add(CusPlan(key = Tags.Tag320, countSetKey = 958, c = (i1: Int, i2: Int) => i1 * 2 + 3))
  add(CusPlan(key = Tags.Tag321, countSetKey = 959, c = (i1: Int, i2: Int) => i1 * i2 + i2 * 2 + i1))
  ...
  add(CusPlan(key = Tags.Tag328, countSetKey = 979, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) i1 - 1 else Option.empty))
  ...
  add(
    CusPlan(
      key = Tags.Tag333,
      countSetKey = 990,
      c = (i1: Int, i2: Int) => if ((i2 + 1) % 2 == 1) i2 + i2 / 2 + 1 else i2 + i2 / 2 + 2
    )
  )
  ...
  add(
    CusPlan(
      key = Tags.Tag345,
      countSetKey = 1007,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 % (i2 + 1) == 0) i1 / (i2 + 1) - 1 else i1 / (i2 + 1)
    )
  )
  add(
    CusPlan(
  ...
  add(CusPlan(key = Tags.Tag352, countSetKey = 1025, c = (i1: Int, i2: Int) => if (i1 <= i2) 0 else 1))
  add(CusPlan(key = Tags.Tag353, countSetKey = 1026, c = (i1: Int, i2: Int) => if (i1 == 0) 2 else if (i1 == 1) 1 else 0))
  add(CusPlan(key = Tags.Tag354, countSetKey = 1027, c = (i1: Int, i2: Int) => if (i1 == 0) 4 else if (i1 == 1) 3 else 2))
  add(CusPlan(key = Tags.Tag355, countSetKey = 1028, c = (i1: Int, i2: Int) => if (i1 == 0) 3 else if (i1 == 1) 2 else 1))
  add(CusPlan(key = Tags.Tag356, countSetKey = 1030, c = (i1: Int, i2: Int) => if (i2 + 1 >= i1) (i2 + 1) * 2 - i1 else i2 + 1))
  add(CusPlan(key = Tags.Tag357, countSetKey = 1031, c = (i1: Int, i2: Int) => if (i1 > i2) i2 else i2 * 2 - i1 + 1))
  add(CusPlan(key = Tags.Tag358, countSetKey = 1033, c = (i1: Int, i2: Int) => if (i1 == 0) i2 + 2 else i2 + 1))
  add(CusPlan(key = Tags.Tag359, countSetKey = 1034, c = (i1: Int, i2: Int) => if (i2 >= i1) i2 - i1 else 0))
  add(CusPlan(key = Tags.Tag360, countSetKey = 1035, c = (i1: Int, i2: Int) => if (i1 > i2) 1 else i2 - i1 + 2))
  add(CusPlan(key = Tags.Tag361, countSetKey = 1036, c = (i1: Int, i2: Int) => if (i1 > i2) 0 else i2 - i1 + 1))
  ...
  add(CusPlan(key = Tags.Tag370, countSetKey = 1062, c = (i1: Int, i2: Int) => if (i1 < 2) 2 else i1 - 1))
  add(CusPlan(key = Tags.Tag371, countSetKey = 1064, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 + 1 else i1 - 1))
  add(CusPlan(key = Tags.Tag372, countSetKey = 1066, c = (i1: Int, i2: Int) => if (i1 == 0) i2 + 1 else i1 + i2 - 1))
  add(CusPlan(key = Tags.Tag373, countSetKey = 1067, c = (i1: Int, i2: Int) => if (i1 == 0) 2 else if (i1 == 1) 1 else i1 - 1))
  add(CusPlan(key = Tags.Tag374, countSetKey = 1068, c = (i1: Int, i2: Int) => if (i1 == 0) 2 else if (i1 == 1) 1 else i1 - 2))
  ...
  add(CusPlan(key = Tags.Tag377, countSetKey = 1071, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 - i1 + 1 else i1 - i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag383, countSetKey = 1078, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i1 == 1) 2 else i1 - 1))
  add(CusPlan(key = Tags.Tag384, countSetKey = 1080, c = (i1: Int, i2: Int) => i1 / (i2 + 1) * i2 + i1 % (i2 + 1) + 1))
  add(CusPlan(key = Tags.Tag385, countSetKey = 1082, c = (i1: Int, i2: Int) => if (i1 <= i2) i1 + 1 else i1 - 1))
  add(
    CusPlan(
      key = Tags.Tag386,
      countSetKey = 1083,
  ...
  add(CusPlan(key = Tags.Tag394, countSetKey = 1093, c = (i1: Int, i2: Int) => if (i1 <= 1) 1 else i1 - 2))
  add(CusPlan(key = Tags.Tag395, countSetKey = 1094, c = (i1: Int, i2: Int) => if (i1 <= i2) 1 else 0))
  add(CusPlan(key = Tags.Tag396, countSetKey = 1095, c = (i1: Int, i2: Int) => if (i1 >= i2) i1 - i2 + 1 else 1))
  add(CusPlan(key = Tags.Tag397, countSetKey = 1096, c = (i1: Int, i2: Int) => i1 / (i2 + 1) + 1))
  add(CusPlan(key = Tags.Tag398, countSetKey = 1098, c = (i1: Int, i2: Int) => if (i1 > i2) Option.empty else 1))
  add(
    CusPlan(
      key = Tags.Tag399,
      countSetKey = 1099,
  ...
  add(
    CusPlan(key = Tags.Tag400, countSetKey = 1101, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i2 == 0) 0 else 1)
  )
  add(CusPlan(key = Tags.Tag401, countSetKey = 1102, c = (i1: Int, i2: Int) => if (i1 - i2 - 1 >= 0) i1 - i2 else 1))
  add(CusPlan(key = Tags.Tag402, countSetKey = 1103, c = (i1: Int, i2: Int) => if (i1 <= i2) 1 else i1 - i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag407, countSetKey = 1109, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 - i1 else i1 - i2))
  add(CusPlan(key = Tags.Tag408, countSetKey = 1110, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 - i1 else 1))
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if (i1                    % (i2 * 2) <= i2) (i1 / (i2 * 2)) * i2 + i1 + 1
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if (i1 % (i2 * 2) <= i2) (i1 / (i2 * 2)) * i2 + i1 % (i2 * 2) + i1
        else (i1 / (i2 * 2)) * i2 + i1 + i2
    )
  )

  add(CusPlan(key = Tags.Tag428, countSetKey = 1063, c = (i1: Int, i2: Int) => if (i1 <= i2) i2 + 1 else if (i2 == 0) 0 else i2 - 1))

  add(CusPlan(key = Tags.Tag429, countSetKey = 1001, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else i1 * i2 + i2 - 1))

  add(CusPlan(key = Tags.Tag430, countSetKey = 973, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i2 + 2))
    ...
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        if (i1 > i2) i2
          ...
          if ((i2 + 1)  % (i1 * 2) <= i1) i2 + ((i2 + 1) / (i1 * 2)) * i1
          else (i2 + 1) % (i1 * 2) - i1 + i2 + ((i2 + 1) / (i1 * 2)) * i1
        }
    )
  )
  ...
  add(
    CusPlan(
      key = Tags.Tag432,
      countSetKey = 934,
      c = (i1: Int, i2: Int) => if (i1 <= i2) i1 else if (i2 == 0) 0 else if (i1 % i2 == 0) (i1 / i2 - 1) * i2 + i1 else (i1 / i2) * i2 + i1
    )
  )

  add(CusPlan(key = Tags.Tag433, countSetKey = 1059, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 > i2) 1 else i2 / i1 * i1 + 1))
  ...
  add(CusPlan(key = Tags.Tag435, countSetKey = 724, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 > i2) i2 + 2 else i1 - 1))
  ...
  add(CusPlan(key = Tags.Tag437, countSetKey = 1115, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else if (i1 <= i2) i1 else i2 - 1))

  add(
    CusPlan(
      key = Tags.Tag438,
      countSetKey = 1100,
      c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i2 == 0) 0 else if (i1 % i2 == 0) (i1 / i2 - 1) * i2 + 1 else (i1 / i2) * i2 + 1
    )
  )
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if ((i1 - 1)                     % (i2 * 2) >= i2)
          (i1 - 1) / (i2 * 2) * i2 + (i1 - 1) % i2
        else
          (i1 - 1) / (i2 * 2) * i2 - 1
    )
  )

  add(CusPlan(key = Tags.Tag441, countSetKey = 966, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (2 % i1 == 0) 6 else 6 + i1 - 2 % i1))

  add(CusPlan(key = Tags.Tag442, countSetKey = 1051, c = (i1: Int, i2: Int) => if (i1 <= i2) Option.empty else if (i2 == 0) 0 else i2 - 1))

  add(
    CusPlan(key = Tags.Tag443, countSetKey = 998, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i2 - i2 / (i1 + 1) - 1)
  )
  ...
  add(
    CusPlan(
      key = Tags.Tag448,
      countSetKey = 925,
      c = (i1: Int, i2: Int) => if (i2 == 0) 0 else if (i1 % i2 == 0) i1 * 2 else i1 * 2 - i1 % i2 + i2
    )
  )
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if ((i2 + 1)                            % (i1 * 2) < i1) (i2 + 1) / (i1 * 2) * i1 - 1
        else (i2 + 1) / (i1 * 2) * i1 - 1 + (i2 + 1) % (i1 * 2) - i1
    )
  )
  ...
  add(
    CusPlan(key = Tags.Tag451, countSetKey = 1057, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i2 * 2 - i2 % i1 - 1)
  )
  ...
  add(CusPlan(key = Tags.Tag453, countSetKey = 778, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else if (i1 == 0) i2 - 1 else i2))

  add(
    CusPlan(
      key = Tags.Tag454,
      countSetKey = 788,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if ((i2 + 1) % (i1 + 1) == 0) i2 - i2 / (i1 + 1) - 1 else i2 - i2 / (i1 + 1)
    )
  )
  ...
  add(CusPlan(key = Tags.Tag457, countSetKey = 974, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 3 else i1 + 1))

  add(CusPlan(key = Tags.Tag458, countSetKey = 1017, c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else if (i2 == 0) 0 else i1 * i2 - i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag460, countSetKey = 783, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else i2 * 2 - (i2 + 1) / (i1 + 1)))
  ...
  add(CusPlan(key = Tags.Tag462, countSetKey = 1075, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i1 == 1) 2 else 0))
  ...
  add(
    CusPlan(
      ...
      countSetKey = 1016,
      c = (i1: Int, i2: Int) =>
        if (i1 <= 2) 0 else if (i2 == 0) 0 else if (i1 % (i2 + 1) == 0) i1 - i1 / (i2 + 1) - 1 else i1 - i1 / (i2 + 1) - 2
    )
  )
  ...
  add(CusPlan(key = Tags.Tag466, countSetKey = 1060, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i2 - i2 % i1))
  ...
  add(CusPlan(key = Tags.Tag469, countSetKey = 1002, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i1 * i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag476, countSetKey = 711, c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else i1 + 1))
  ...
  add(
    CusPlan(
      key = Tags.Tag484,
      countSetKey = 1022,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) Option.empty else if (i1 <= i2) 0 else (i1 - 1) / i2 - 1
    )
  )
  ...
  add(CusPlan(key = Tags.Tag486, countSetKey = 1061, c = (i1: Int, i2: Int) => if (i1 <= 1) 2 else 0))

  add(CusPlan(key = Tags.Tag487, countSetKey = 983, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i2 - 1 - i2 % i1))
  ...
  add(CusPlan(key = Tags.Tag489, countSetKey = 1015, c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else i1 / 2 - 1))
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if (i2 % (i1 * 2) >= i1) i2 + i2 / (i1 * 2) * i1 + i2 % i1
        else i2 + i2 / (i1 * 2) * i1 - 1
    )
  )
  ...
  add(CusPlan(key = Tags.Tag497, countSetKey = 712, c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else 3))
  ...
  add(CusPlan(key = Tags.Tag499, countSetKey = 707, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i1 / 2 - 1))
  ...
  add(CusPlan(key = Tags.Tag502, countSetKey = 717, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i1 / (i2 + 1) - 1))
  ...
  add(
    CusPlan(
      key = Tags.Tag505,
      countSetKey = 1023,
      c = (i1: Int, i2: Int) => if (i1 <= 1) 0 else if (i2 == 0) 0 else if (i2 == 1) i1 - 2 else if (i1 <= i2) 0 else i1 - (i1 - 1) % i2 - 2
    )
  )
  ...
  add(CusPlan(key = Tags.Tag507, countSetKey = 978, c = (i1: Int, i2: Int) => if (i1 == 0 && i2 == 0) 0 else i1 * i2 + i1 + i2 - 1))
  ...
  add(CusPlan(key = Tags.Tag511, countSetKey = 1084, c = (i1: Int, i2: Int) => if (i1 == 0) 1 else if (i2 == 0) 0 else i2 - 1))

  add(
    CusPlan(
      key = Tags.Tag512,
      countSetKey = 976,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 + i2 * 2 - i2 % i1 + 2
    )
  )

  add(
    CusPlan(key = Tags.Tag513, countSetKey = 1126, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i1 - (i1 - 1) % i2 - 1)
  )
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        ...
        else if (i1                  % (i2 * 2) >= i2) i1 / (i2 * 2) * i2 + i2 - 1
        else i1 / (i2 * 2) * i2 + i1 % (i2 * 2) - 1
    )
  )
  ...
  add(
    CusPlan(
      ...
      c = (i1: Int, i2: Int) =>
        if (i2 == 0) 0
        else if (i1 == 0) i1 + i2 - 1
        else if (i1 == i2) i1 + i2 - 1
        else if (i1 < i2) i1 + i2 - 1
        else if (i2 % (i1 + 1) == 0) i1 + i2 - 1
        else i2 * 2
    )
  )
  ...
  add(CusPlan(key = Tags.Tag518, countSetKey = 995, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else i2 * 2 - i2 / (i1 + 1) - 1))
  ...
  add(
    CusPlan(
      key = Tags.Tag525,
      countSetKey = 1056,
      c = (i1: Int, i2: Int) => if (i1 == 0) Option.empty else if (i1 >= i2) 0 else i2 / i1 - 1
    )
  )
  ...
  add(
    CusPlan(
      ...
      countSetKey = 796,
      c = (i1: Int, i2: Int) =>
        if (i1 == 0) 0 else if (i2 % (i1 * 2) >= i1) i2 / (i1 * 2) * i1 + i1 - 1 else i2 / (i1 * 2) * i1 + i2 % (i1 * 2)
    )
  )

  add(CusPlan(key = Tags.Tag528, countSetKey = 1019, c = (i1: Int, i2: Int) => if (i1 <= i2) 0 else i1 / (i2 + 1) - 1))
  ...
  add(
    CusPlan(
      key = Tags.Tag532,
      countSetKey = 1009,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i2 == 0) 0 else i1 - i1 / (i2 + 1) - 1
    )
  )
  ...
  add(CusPlan(key = Tags.Tag534, countSetKey = 1037, c = (i1: Int, i2: Int) => if (i2 == 0) 0 else (i2 + 1) / (i1 + 1) + i2 - 1))

  add(CusPlan(key = Tags.Tag535, countSetKey = 676, c = (i1: Int, i2: Int) => if (i1 == 0) 0 else i1 * 2 - i1 / (i2 + 1) - 1))

  add(
    CusPlan(
      key = Tags.Tag536,
      countSetKey = 708,
      c = (i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 % (i2 + 1) == 0) i1 * 2 - i1 / (i2 + 1) - 1 else i1 * 2 - i1 / (i2 + 1) - 2
    )
  )
