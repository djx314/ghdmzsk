...
object SetsCol extends SetsColAbs {
  ...
  // Tags.Tag156.firstart(1).secondStart(0).value((i1: Int, i2: Int) => i1)
  // Tags.Tag157.firstart(1).secondStart(0).value((i1: Int, i2: Int) => i1)
  // Tags.Tag158.firstart(1).secondStart(0).value((i1: Int, i2: Int) => i1)
  // Tags.Tag159.firstart(1).secondStart(0).value((i1: Int, i2: Int) => i1)
  // Tags.Tag160.firstart(1).secondStart(0).value((i1: Int, i2: Int) => i1)
