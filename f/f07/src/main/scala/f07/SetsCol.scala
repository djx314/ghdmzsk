...
object SetsCol extends SetsColAbs {
  ...
  // Tags.Tag105.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag106.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag107.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag108.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag109.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag110.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag111.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag112.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag113.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
  // Tags.Tag114.firstart(0).secondStart(0).value((i1: Int, i2: Int) => if (i1 == 0) 0 else if (i1 == 1) 1 else 2)
