...
object Runner {
  ...
  def 加数被加数(n: Int): Number1 = n match {
    case n1 if n1 > 0 => Number1S(() => 加数被加数(n1 - 1))
    case 0            => number1vZero
  }
  def 被减数被乘数被除数(n: Int): Number1 = n match {
    case n1 if n1 > 0 => Number1V(() => 被减数被乘数被除数(n1 - 1))
    case 0            => number1tZero
  }
  ...
  def main(arr: Array[String]): Unit = {
    ...
    }
    {
      for {
        ...
        def number4                        = number2Zero.method1(number1)
        val count1                         = count(() => number3)
        val count2                         = count(() => number4)
        val count3                         = i1 * i2
    ...
    }
    {
      for {
        ...
        def number4                        = number2Positive.method1(number1)
        val count1                         = count(() => number3)
        val count2                         = count(() => number4)
        val count3                         = if (i3 == 0) i1 else i1 + 1
        assert(count1 == count3)
        assert(count2 == i1)
      }
    }
