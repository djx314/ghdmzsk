...
case object BottomNumber1 extends Number2 with Number3 {
  override def method2(number1: Number1): Number5                   = number1.method1(BottomNumber0)
...
case object YBottomNumber1 extends Number4 {
  ...
  override def method5(number3: Number3, number1: Number1): Number5 = number1.method1(TopNumber0(number3))
}
