...
object Ops1 {
  ...
  class ops_:::[A] extends Context[Number[A], A, Number[A]] {
  ...
  class ops_collect[A, B] extends Context[PartialFunction[A, B], A, Number[B]] {
  ...
  class ops_contains[A, A1 >: A] extends Context[A1, A, Boolean] {
  ...
  class ops_corresponds1[A, B] extends Context[(Number[B], (A, B) => Boolean), A, Boolean] {
  ...
  class ops_corresponds2[A, B] extends Context[(Number[A], (A, B) => Boolean, A), B, Boolean] {
  ...
  class ops_equals1[A, B] extends Context[Number[B], A, Boolean] {
  ...
  class ops_equals2[A, B] extends Context[(Number[A], A), B, Boolean] {
  ...
  class ops_equals3[B] extends Context[Unit, B, Boolean] {
    override def bindS(t: Unit, current: () => Number[B], head: B): Boolean = false
    override def bindT(t: Unit, current: () => Number[B]): Boolean          = true
  }

  class existsContext[A] extends Context[A => Boolean, A, Boolean] {
