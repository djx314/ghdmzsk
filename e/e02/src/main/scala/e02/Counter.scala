...
class Context1[S] extends Context[Number[Unit], S, Collect[S]] {
...
class Context2[S] extends Context[(Number[S], S), Unit, Collect[S]] {
...
class Context3[S] extends Context[Number[S], Unit, Collect[S]] {
