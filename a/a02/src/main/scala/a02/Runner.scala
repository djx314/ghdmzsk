...
object Runner {
  ...
  def main(arr: Array[String]): Unit = {
    ...
    }
    {
      ...
      val count1  = plus[Number1, Number2T]()
      val result1 = 1 + 0
      assert(count1 == result1)
    }
    {
    ...
    {
      type Number2 = Number2S[Number2T]
      val count1  = plus[Number1T, Number2]()
      val result1 = 0 + 1
      assert(count1 == result1)
    }
    {
      type Number1 = Number1S[Number1T]
      type Number2 = Number2S[Number2T]
      val count1  = plus[Number1, Number2]()
      val result1 = 1 + 1
      assert(count1 == result1)
    }
    {
    ...
    {
      type Number2 = Number2S[Number2S[Number2T]]
      val count1  = plus[Number1T, Number2]()
      val result1 = 0 + 2
      assert(count1 == result1)
    }
