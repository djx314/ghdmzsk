...
object Runner {
  ...
  val number2 = Number3S(Number3S(Number3S(Number3S(Number3S(Number3T, item03), item04), item05), item06), item07)
  val number3 = Number4S(Number4S(Number4S(Number4S(Number4S(Number4T, item08), item09), item10), item11), item12)
  ...
  val number10 = Number4S(Number4S(Number4S(Number4S(Number4S(Number4S(Number4T, item08), item09), item10), item11), item12), item13)
  val number11 = Number2S(Number2T, item01)

  val number12 = Number2S(Number2S(Number2S(Number2S(Number2T, item01), item02), item03), item04)
  val number13 = Number3S(Number3S(Number3T, item05), item06)
  val number14 = Number4S(Number4S(Number4S(Number4S(Number4S(Number4S(Number4T, item07), item08), item09), item10), item11), item12)
  val number15 = Number2T

  val number16 = Number2S(Number2S(Number2T, item01), item02)
  val number17 = Number3S(Number3S(Number3T, item03), item04)
  val number18 =
    Number4S(Number4S(Number4S(Number4S(Number4S(Number4S(Number4S(Number4T, item05), item06), item07), item08), item09), item10), item11)
  val number19 = Number4S(Number4S(Number4S(Number4T, item05), item06), item07)

  val number20 = Number2S(Number2S(Number2T, item01), item02)
  val number21 = Number3S(Number3S(Number3T, item03), item04)
  val number22 = Number4S(Number4S(Number4S(Number4S(Number4T, item05), item06), item07), item08)

  def main(args: Array[String]): Unit = {
    assert(Counter.count(number1, number2, number3) == number1)
