  ...
  def main(args: Array[String]): Unit = {
    ...
    }
    {
      for {
        ...
        lazy val number2t: Number2 = Number2T(() => number2s)
        val number3 =
          try Option(number1.method1(number2s))
          catch {
            case e: StackOverflowError => Option.empty
          }
        val number4 =
          try Option(number1.method1(number2t))
          catch {
            case e: StackOverflowError => Option.empty
          }
        ...
        val result1 =
          if (count1 == 0) Option(0)
          else if (count2 == 0) Option.empty
          else if (count1 % count2 == 0) Option(count1 / count2 - 1)
          else Option(count1 / count2)
        val result2 =
          if (count1 == 0) Option(0)
          else if (count2 == 0) Option.empty
          else if (count1 % count2 == 0) Option(count1 / count2)
          else Option(count1 / count2 + 1)
