...
trait Number1 {
  def method1(number2: Number2, item1: Item2): Number3
}
case class Number1S(tail: Number1, head: Item1) extends Number1 {
  override def method1(number2: Number2, item1: Item2): Number3 = number2.method2(tail)
}
case object Number1T extends Number1 {
  override def method1(number2: Number2, item1: Item2): Number3 = Number3T
}
