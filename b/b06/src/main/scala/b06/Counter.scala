...
case class Number1T(tail: () => Number1) extends Number1 {
  def method1(number2: Number2, number3: Number3): Number4 = Number4S(tail().method1(number2, number3))
}
...
case class Number2T(tail: () => Number2) extends Number2 {
  def method2(number1: Number1, number3: Number3, item1: Item1): Number4 = number3.method3(number1, tail(), item1)
}
...
case class Number3S(tail: Number3, head: Item3) extends Number3 {
  def method3(number1: Number1, number2: Number2, item1: Item1): Number4 = number2.method2(number1, tail, item1)
}
case object Number3T extends Number3 {
  def method3(number1: Number1, number2: Number2, item1: Item1): Number4 = Number4T
}
