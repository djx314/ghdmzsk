...
case class Number2S(tail: Number2, head: Item2) extends Number2 {
  override def method2(number1: Number1, number3: Number3, item1: Item1): Number4 = number3.method3(number1, tail, item1, head)
}
...
case class Number3S(tail: Number3, head: Item3) extends Number3 {
  override def method3(number1: Number1, number2: Number2, item1: Item1, item2: Item2): Number4 = number2.method2(number1, tail, item1)
}
case class Number3T(tail: () => Number3) extends Number3 {
  override def method3(number1: Number1, number2: Number2, item1: Item1, item2: Item2): Number4 = Number4S(
